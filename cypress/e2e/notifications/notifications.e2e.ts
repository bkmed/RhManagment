...
describe('Notifications', () => {
    ...
    cy.intercept('GET', '**/notifications*', {
      body: [
        ...
        },
        {
          ...
          message:
            'Your vacation leave request from 2023-07-10 to 2023-07-15 has been approved',
          read: true,
  ...
  it('should display notifications list', () => {
    ...
    cy.contains('Your payslip for June 2023 is now available').should(
      'be.visible',
    );
  ...
  it('should show unread indicator for new notifications', () => {
    cy.contains('New Payslip Available')
      .parent()
      .parent()
      .find('.unreadIndicator')
      .should('be.visible');
    cy.contains('Leave Request Approved')
      .parent()
      .parent()
      .find('.unreadIndicator')
      .should('not.exist');
