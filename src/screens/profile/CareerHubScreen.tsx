    ...
    <View key={goal.id} style={styles.goalCard}>
      <View style={styles.goalHeader}>
        <View style={styles.goalTitleContainer}>
          ...
          <Text
            style={[
              styles.statusBadge,
              { backgroundColor: getStatusColor(goal.status, theme) },
            ]}
          >
        ...
        <View style={styles.progressActions}>
          {[0, 25, 50, 75, 100].map(val => (
            <TouchableOpacity
              ...
              style={[
                styles.progressStep,
                goal.progress === val && styles.activeStep,
              ]}
            >
              <Text
                style={[
                  styles.stepText,
                  goal.progress === val && styles.activeStepText,
                ]}
              >
                {val}%
              </Text>
      ...
      <View style={styles.goalFooter}>
        <Text style={styles.deadlineText}>
          📅 {t('common.deadline')}: {formatDate(goal.deadline)}
        </Text>
      </View>
    </View>
  );
    ...
    <View style={styles.container}>
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        <View style={styles.statsGrid}>
          <View
            style={[styles.statBox, { borderLeftColor: theme.colors.primary }]}
          >
            <Text style={styles.statVal}>{goals.length}</Text>
            <Text style={styles.statLabel}>{t('common.total')}</Text>
          </View>
          <View
            style={[styles.statBox, { borderLeftColor: theme.colors.success }]}
          >
          ...
          <View
            style={[styles.statBox, { borderLeftColor: theme.colors.warning }]}
          >
            <Text style={styles.statVal}>
        ...
        <View style={styles.modalOverlay}>
          <View style={styles.modalContent}>
            <Text style={styles.modalTitle}>
              {editingGoal ? t('common.edit') : t('common.add')}{' '}
              {t('common.goal')}
            </Text>
