...
const HOLIDAYS: Record<CountryCode, Holiday[]> = {
    France: [
        ...
        { date: '2025-04-21', name: { en: 'Easter Monday', fr: 'Lundi de Pâques' } },
        ...
        { date: '2025-06-09', name: { en: 'Whit Monday', fr: 'Lundi de Pentecôte' } },
    ...
    Tunisia: [
        { date: '2025-01-01', name: { en: 'New Year', fr: 'Jour de l’an' } },
        { date: '2025-01-14', name: { en: 'Revolution Day', fr: 'Fête de la Révolution' } },
        { date: '2025-03-20', name: { en: 'Independence Day', fr: 'Fête de l’Indépendance' } },
        { date: '2025-03-30', name: { en: 'Eid al-Fitr', fr: 'Aïd al-Fitr' } },
        { date: '2025-03-31', name: { en: 'Eid al-Fitr Holiday', fr: 'Congé Aïd al-Fitr' } },
        { date: '2025-04-09', name: { en: 'Martyrs Day', fr: 'Fête des Martyrs' } },
        { date: '2025-05-01', name: { en: 'Labor Day', fr: 'Fête du Travail' } },
        { date: '2025-06-06', name: { en: 'Eid al-Adha', fr: 'Aïd al-Adha' } },
        { date: '2025-06-07', name: { en: 'Eid al-Adha Holiday', fr: 'Congé Aïd al-Adha' } },
        { date: '2025-07-25', name: { en: 'Republic Day', fr: 'Fête de la République' } },
        { date: '2025-08-13', name: { en: 'Women Day', fr: 'Fête de la Femme' } },
        { date: '2025-10-15', name: { en: 'Evacuation Day', fr: 'Fête de l’Évacuation' } },
        { date: '2025-12-17', name: { en: 'Revolution Day (Dec)', fr: 'Fête de la Révolution' } },
    ],
    Egypt: [
        { date: '2025-01-07', name: { en: 'Coptic Christmas', fr: 'Noël Copte' } },
        { date: '2025-01-25', name: { en: 'Revolution Day', fr: 'Fête de la Révolution' } },
        { date: '2025-03-31', name: { en: 'Eid al-Fitr', fr: 'Aïd al-Fitr' } },
        { date: '2025-04-20', name: { en: 'Easter (Coptic)', fr: 'Pâques Copte' } },
        { date: '2025-04-21', name: { en: 'Sham El Nessim', fr: 'Cham El Nessim' } },
        { date: '2025-04-25', name: { en: 'Sinai Liberation Day', fr: 'Libération du Sinaï' } },
        { date: '2025-05-01', name: { en: 'Labor Day', fr: 'Fête du Travail' } },
        { date: '2025-06-07', name: { en: 'Eid al-Adha', fr: 'Aïd al-Adha' } },
        { date: '2025-06-30', name: { en: 'June 30 Revolution', fr: 'Révolution du 30 juin' } },
        { date: '2025-07-23', name: { en: 'Revolution Day', fr: 'Fête de la Révolution' } },
        { date: '2025-10-06', name: { en: 'Armed Forces Day', fr: 'Fête des Forces Armées' } },
    ],
};
