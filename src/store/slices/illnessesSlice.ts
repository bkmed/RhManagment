...
export const { setIllnesses, addIllness, updateIllness, deleteIllness } =
  illnessesSlice.actions;

export const selectAllIllnesses = (state: { illnesses: IllnessesState }) =>
  state.illnesses.items;

export const selectExpiringSoonIllnesses = (state: {
