...
export const { setInvoices, addInvoice, updateInvoice, deleteInvoice } = invoicesSlice.actions;

export const selectAllInvoices = (state: { invoices: InvoicesState }) => state.invoices.items;
