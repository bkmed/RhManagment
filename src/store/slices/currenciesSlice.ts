...
export const { setCurrencies, addCurrency, updateCurrency, deleteCurrency } = currenciesSlice.actions;

export const selectAllCurrencies = (state: { currencies: CurrenciesState }) => state.currencies.items;
export const selectCurrencyById = (id: number) => (state: { currencies: CurrenciesState }) =>
