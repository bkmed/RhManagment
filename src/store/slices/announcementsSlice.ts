...
export const { setAnnouncements, addAnnouncement, updateAnnouncement, deleteAnnouncement } = announcementsSlice.actions;

export const selectAllAnnouncements = (state: RootState) => state.announcements.announcements;
